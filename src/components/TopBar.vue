  ...
  <div class="bg-gray-200 text-gray-700 py-2">
    <div class="container mx-auto flex justify-between items-center text-xs px-4">
      <div class="flex items-center space-x-4">
        ...
        <a href="#nav" class="hover:underline">Ir para o menu</a>
        <a href="#search" class="hover:underline">Ir para a busca</a>
        <a href="#footer" class="hover:underline">Ir para o rodapé</a>
      </div>
      <div class="flex items-center space-x-4">
        ...
        <a href="#" class="hover:underline">A</a>
        <a href="#" class="hover:underline">A-</a>
        <a href="#" class="hover:underline">Alto Contraste</a>
